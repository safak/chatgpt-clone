...
//       setOriginalFileName(""); // Clear original file name
...
//       console.log("File uploaded successfully to the server:", serverResponse?.data);
...
//       setOriginalFileName(file.name); // Save the original name before uploading
//     }
//   };
